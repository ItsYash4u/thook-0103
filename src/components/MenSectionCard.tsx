...
interface MenSectionCardProps {
  ...
  image: string;
  alt: string;
  onClick: () => void; // required for routing!
}
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center w-full">
        <span style={{ width: "100%" }}>
          <button
            ...
            className="w-full bg-[#ffd600] hover:bg-[#ffec80] active:scale-95 rounded px-8 py-2 text-lg tracking-wide font-black text-black border border-[#ffd600] shadow-none uppercase overflow-hidden shine-btn"
            style={{ letterSpacing: "0.09em" }}
            disabled={loading}
          >
      ...
      <style>{`
        ...
        .shine-btn:hover .shine-effect, .shine-btn:focus .shine-effect {
          animation: shine-diagonal 1.1s cubic-bezier(.22,.61,.36,1) 1;
        }
        @keyframes shine-diagonal {
          0% {
